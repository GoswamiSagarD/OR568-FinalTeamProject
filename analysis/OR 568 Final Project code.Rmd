...
#h0: bike sharing is more popular during the holidays 
#h1: bike sharing is more popular during work days/none holidays 
```
...
```{r}
t.test(bikecount~workhours, data=df2, subset= workhours %in% c(0, 1))
